var CZombies = function (b, a) {
    return (a = function () {
        ...
        getFireball: function (h, e, g) {
            ...
            var f = h.AttackedLX, j = h.AttackedRX, c = !g ? oZ.getArZ(f, f + 40, h.R) : oZ.getArZ(j - 40, j, h.R), d = c.length;
            while (d--) {
                c[d].getSputtering()
            }
        },
        ...
        getSlow: function (h, f, g) {
            var d = oSym.Now + g, e = h.FreeSlowTime, c = 0;
            switch (true) {
                case !e:
        ...
        ChangeR: function (e) {
            var h = e.R, g = e.ar || [], j = e.CustomTop, d = this, q = h - 1, l, k = d.id, m = -1, f = d.Ele, n = d.EleBody, i = oGd.$LF, c;
        ...
        prepareBirth: function (f) {
            var h = this, e = h.ArR, d = e[Math.floor(Math.random() * e.length)], g = GetY(d) + h.GetDY(), c = g - h.height, j = 3 * d + 1, i = h.id = "Z_" + Math.random();
            h.R = d;
            h.pixelTop = c;
            h.zIndex = j;
        ...
        CustomBirth: function (i, c, d, m) {
            var g = this, f = GetY(i) + g.GetDY(), h = f - g.height, k = 3 * i + 1, e = g.id = "Z_" + Math.random(), l = g.beAttackedPointL, j = g.beAttackedPointR;
        ...
        ExchangeLR: function (f, d) {
            var e = f.width, h = f.beAttackedPointL, c = f.beAttackedPointR, g = f.Ele;
    ...
    getHurt: function (i, a, g, l, c, k, j) {
        ...
        var b = e.id, h = e.HP, d = e.PicArr, f = e.isAttacking;
        switch (true) {
            case (h -= g) < 1:
                e.HP = 0;
                e.Die(j);
    ...
    getSlow: function (f, d, e) {
        var b = oSym.Now + e, c = f.FreeSlowTime, a = 0;
        switch (true) {
            case !c:
                f.Attack = 50;
            case c < b:
    ...
    CustomBirth: function (g, d, a, b, j) {
        var e = this, c = GetY(g) + e.GetDY(), f = c - e.height, i = e.beAttackedPointL, h = e.beAttackedPointR;
    ...
    BirthCallBack: function (e) {
        var d = e.delayT, c = e.id, b = e.Ele = $(c), a = e.EleBody = b.childNodes[1];
    ...
    PicArr: (function () {
        var d = "images/Zombies/DancingZombie/", c = $User.Browser.IE6 ? "_8" : "", a = d + "spotlight" + c + ".png" + $Random, b = d + "spotlight2" + c + ".png" + $Random;
    ...
    ResetBackupDancer: function (f) {
        var g = f.ArDZ, d = 4, c, b, e, a = f.DZStep;
        while (d--) {
        ...
        a > -1 && oSym.addTask(f.DZStepT - oSym.Now, function (o, j) {
            var m = 4, l, k, n, h = "ChangeChkActsTo" + j;
            while (m--) {
    ...
    BirthCallBack: function (d) {
        var b = d.delayT, l = d.id, a = d.Ele = $(l), c = 320, i = oGd.$LF, g = d.R, s = g - 1, n = g + 1, e, r, q = LX - 60, m = LX + 100, k = LX - 130, j = LX - 70, h = LX + 30, f = d.ArDZ = [0, 0, 0, 0];
    ...
    ChkSpeed: function (g) {
        ...
        var h = g.ArDZ, d = 4, c, b, e, a = g.OSpeed, f = [];
        switch (true) {
    ...
    TurnLeft: function (c) {
        var a = CZombies.prototype, b = c.id;
        ...
        c.getSlow = function (i, g, h) {
            var e = oSym.Now + h, f = i.FreeSlowTime, d = 0;
            switch (true) {
                case !f:
                    i.Attack = 50;
                case f < e:
    ...
    Summon: function (d, c) {
        ...
        oSym.addTask(10, function (f, e) {
            ...
            g && g.beAttacked && (e.src = "images/Zombies/DancingZombie/Summon2.gif", oSym.addTask(10, function (t, s, x) {
                var h = $Z[t], v = h.ZX, m = h.ArDZ, n = [], k = "images/Zombies/BackupDancer/Mound.gif" + $Random + Math.random(), r = 4, w = [], u = [], o = 0, q, l;
                if (h && h.beAttacked) {
    ...
    EName: "oZombie", CName: "领带僵尸", StandGif: 9, PicArr: (function () {
    ...
    getHurt: function (i, a, g, m, c, k, j) {
        ...
        var b = e.id, l = e.OrnHP, h = e.HP, f = e.isAttacking, d = e.PicArr;
        switch (true) {
            case (l -= g) > 0:
                e.OrnHP = l;
                break;
    ...
    JudgeAttack: function () {
        ...
        for (f = c - 2; f <= c; f++) {
            ...
            for (a = 2; a > -1; (p = h[d + f + "_" + a--]) && (p.EName != "oBrains" ? p.AttackedRX >= e && p.AttackedLX < b && p.canEat && (a = -1, g.JudgeAttack = CZombies.prototype.JudgeAttack, g.NormalAttack(g.id, p.id)) : p.AttackedRX >= b && p.AttackedLX < b && (a = -1, g.JudgeAttack = CZombies.prototype.JudgeAttack, (g.NormalAttack = CZombies.prototype.NormalAttack)(g.id, p.id)))) {
            }
        }
    },
    getRaven: function (a) {
    ...
    NormalAttack: function (d, b) {
        var g = $Z[d], f = $P[b].AttackedLX, a = g.Ele, c = g.EleShadow, e = g.EleBody;
    ...
    BirthCallBack: function (g) {
        var e = g.delayT, c = g.id, b = g.Ele = $(c), d = g.AttackedLX, f, a, h;
    ...
    ExchangeLR: function (d, b) {
        var c = d.width, f = d.beAttackedPointL, a = d.beAttackedPointR, e = d.Ele;
    ...
    SunNum: 75,
    PicArr: (function () {
        var b = "images/Zombies/DuckyTubeZombie2/", a = "images/Zombies/DuckyTubeZombie1/";
    ...
    SunNum: 125,
    PicArr: (function () {
        var b = "images/Zombies/DuckyTubeZombie3/", a = "images/Zombies/DuckyTubeZombie1/";
        return ["images/Card/Zombies/DuckyTubeZombie1.png", "images/Card/Zombies/DuckyTubeZombie1G.png", b + "Walk1.gif", b + "Walk2.gif", b + "1.gif", b + "Attack.gif", "images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, a + "Walk1.gif", a + "Walk2.gif", a + "Attack.gif"]
    })()
    ...
    JudgeAttack: function () {
        var e = this, b = e.ZX, c = e.R + "_", d = GetC(b), g = oGd.$, a, f = e.id;
    ...
    JudgeAttackH: function () {
        var c = this, b = oZ.getZ0(c.ZX, c.R), d = c.id, a;
