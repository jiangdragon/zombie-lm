var $User = function () {
    var a = navigator.platform, f = navigator.userAgent, c = (a == "Win32" || a == "Windows");
    var e = (a == "Mac68K" || a == "MacPPC" || a == "Macintosh"), b = (a == "X11" && !c && !e);
    var h = c || e || b, g = "pvz.lonelystar.org", d = !!(window.attachEvent && !window.opera);
    return {
        Browser: {
            IE: d,
...
var ShadowPNG = "images/interface/plantshadow" + ($User.Browser.IE6 ? (document.execCommand("BackgroundImageCache", false, true), "8.gif") : "32.png");
...
var oS = {
    ...
    LoadProgress: function (r, l, a) {
        ...
        var d = document.createTextNode("正在准备载入游戏素材。。。"), t = GetX(11);
        var g = oGd.$LF, b = oGd.$ZF, c = oS.R + 1, e = p.LoadImage, h = p.CheckImg, f = p.InitPn, m, q;
    ...
    CheckImg: function (d, c) {
        ...
        if (g.AccessNum == g.PicNum) {
            ...
            delete g.LF;
            delete g.ZF;
            var b = {background: "url(" + g.backgroundImage + ") no-repeat", visibility: "visible"};
...
var oCoord = {
    1: function () {
        ...
        GetY = function (a) {
            return $SEql(a, {0: 75, 1: 175, 2: 270, 3: 380, 4: 470, 5: 575})
        };
        GetY1Y2 = function (a) {
            return $SEql(a, {0: [0, 85], 1: [86, 180], 2: [181, 280], 3: [281, 385], 4: [386, 475], 5: [476, 600]})
        };
        GetX1X2 = function (a) {
            return $SEql(a, {
                "-2": [-100, -49],
        ...
        GetY = function (a) {
            return $SEql(a, {0: 75, 1: 165, 2: 253, 3: 355, 4: 430, 5: 522, 6: 587})
        };
        GetY1Y2 = function (a) {
            return $SEql(a, {
                0: [0, 85],
    ...
    Init: function (a) {
        ...
        var e = oP, m = e.ArZ, k = e.AZ, s = k.length, q, r, i = [], g = 0, n = oS.LargeWaveFlag[d], c = false, h = !n ? 150 : (n.style.top = "5px", --j, i[g++] = oFlagZombie, 30), p, b, f = e.MustShowAtFlag, a;
        while (s--) {
            if ((r = (q = k[s])[1]) > d) {
                break
            } else {
        ...
        var h = oP, c = [], a = 0, g = h.ArZ, f = oS.LargeWaveFlag[h.FlagZombies], e = h.SumToZombie, b = !f ? 150 : (f.style.top = "5px", --d, c[a++] = oFlagZombie, 30);
        while (d > 0) {
        ...
        var f = oGd.$LF, l = [], c = f.length, m = [], k = [], g = h.length, a, d = b - j + 1;
        while (--c) {
            f[c] == 2 && l.push(c)
        }
        a = l.length;
        ...
        asyncInnerHTML(a.join(""), function (h, f) {
            ...
            while (e--) {
                ...
                oSym.addTask(10, function (l, k, i, j) {
                    k = Math.max(k - j, 0);
                    SetStyle(l, {top: k + "px", clip: "rect(0,auto," + (i += j) + "px,0)"});
    ...
    Init: function () {
        ...
        var d = e.id, k = $(d), h = e.Attack, a = e.D, p, q = e.X, c = GetC(q), g = e.R, n = e.Kind, l = e.ChangeC, b = oZ["getZ" + a](q, g);
        ...
        var c = d.id, j = d.X, a = GetC(j), f = d.R, b = oZ.getZ0(j, f), e = $(c);
        ...
        var h = g.id, b = $(h), f = oZ.getZ0(g.X, g.R), e = g.D, c = g.pixelTop;
        if (f && f.Altitude == 1) {
    ...
    Init: function (b) {
        ...
        var d = 0, j = this.$[b], f = this.$R[b], g, c, k, e;
        ...
        var a, b = this.$, j, l = 0, d = 0, k = 1000, i, h, f = [function (n) {
            d = 1;
            k = i
        }, function (n) {
        ...
        (function (r) {
            var q = (j = b[r]).length, n = arguments.callee, p = oT.$[r], s = oT.$L[r];
            while (q--) {
                a = j[q];
    ...
    Init: function (b) {
        ...
        var f = new RegExp(d + ",", "g"), h = (j.toString() + ",").replace(f, "┢,").replace(/[^,┢]/g, ""), i = 0, g = 0, b = [];
    ...
    i = window.event || i;
    var a = i.clientX + EBody.scrollLeft || EElement.scrollLeft, k = i.clientY + EBody.scrollTop || EElement.scrollTop, g = ChosePlantX(a), h = ChosePlantY(k), d = g[0], c = h[0], f = h[1], b = g[1], j = GetAP(a, k, f, b);
    switch (oS.Chose) {
        case 1:
    ...
    j = window.event || j;
    var d = j.clientX + EBody.scrollLeft || EElement.scrollLeft, b = j.clientY + EBody.scrollTop || EElement.scrollTop, k = oS.ChoseCard, h = ChosePlantX(d), i = ChosePlantY(b), f = h[0], c = i[0], g = i[1], a = h[1], m = GetAP(d, b, g, a);
    ...
    k = window.event || k;
    var d = k.clientX + EBody.scrollLeft || EElement.scrollLeft, b = k.clientY + EBody.scrollTop || EElement.scrollTop, m = oS.ChoseCard, h = ChosePlantX(d), i = ChosePlantY(b), f = h[0], c = i[0], g = i[1], a = h[1], n = GetAP(d, b, g, a);
    var j = n[1], l = j ? j.id : "", p = oS.MPID;
    ...
    var c = oP.AZ.slice(0), b = l2 = c.length, f, g = $("dZombie"), e = [], d = [], a;
    while (b--) {
    ...
    var d = "", g, f, e = [oPeashooter, oSunFlower, oCherryBomb, oWallNut, oPotatoMine, oSnowPea, oChomper, oRepeater, oPuffShroom, oSunShroom, oFumeShroom, oGraveBuster, oHypnoShroom, oScaredyShroom, oIceShroom, oDoomShroom, oLilyPad, oSquash, oThreepeater], a = e.length, b = 0, c;
    while (b < a) {
        g = e[b];
        c = g.prototype;
        f = c.EName;
    ...
    var d = "", g, f, e = [oZombie, oFlagZombie, oConeheadZombie, oPoleVaultingZombie, oBucketheadZombie, oNewspaperZombie, oScreenDoorZombie, oFootballZombie, oDancingZombie, oBackupDancer, oDuckyTubeZombie1, oSnorkelZombie], a = e.length, b = 0, c;
    while (b < a) {
        g = e[b];
        c = g.prototype;
        f = c.EName;
    ...
    SetStyle(f, {left: c.clientX + EDAll.scrollLeft - 3 + "px", top: c.clientY + 18 + "px", visibility: "visible"})
},
    SelectCard = function (e) {
    var i = $("Card" + e).childNodes, g = i[1], c = i[0], b = ArPCard[e], j = b.PName.prototype, h, a, k, f = $("btnOK");
    if (!b.Select) {
        if (!(ArPCard.SelNum |= 0)) {
            f.disabled = "";
            f.style.color = "#FC6"
    ...
    LetsGO = function () {
    var b = $("dZombie"), f = $("dCardList"), h = 0, l = f.childNodes.length, g, j, m, e, k, a, c = document.body;
    ...
    a = window.event || a;
    var g = a.clientX + EBody.scrollLeft || EElement.scrollLeft, e = a.clientY + EBody.scrollTop || EElement.scrollTop, d = h.PName.prototype, c = ArCard.length, b;
    oS.Chose = 1;
    ...
    var b, d, g = "Sun" + Math.random(), c = "cursor:pointer;z-index:25;filter:alpha(opacity=80);opacity:0.8;left:" + h + "px;";
    switch (e) {
        case 25:
    ...
    var a = 15, c = ArSun[b], e = 85, i = -20, d = c.left, h = c.top, g = Math.round((d - e) / a), f = Math.round((h - i) / a);
    ...
    oSym.Init(function (d, e) {
        ++d < 100 ? (SetAlpha(e, d, d * 0.01), oSym.addTask(1, arguments.callee, [d, e])) : function () {
            ...
            SetStyle($("dNewPlant"), {visibility: "visible", zIndex: 255});
            oSym.Stop()
        }()
    }, [0, $("DivA")])
},
    ...
    var q = oGd.$Tombstones, h = [], g = oS.R + 1, b, c = 0, p, a, f, e, r = oGd.$, k, n;
    while (--g) {
        f = d;
        while (f >= m) {
            !q[g + "_" + f] && (h[c++] = [g, f]);
    ...
    while (l--) {
        ...
        NewEle("", "div", "background-position:-" + 86 * b + "px -" + 91 * g + "px", {className: "Tom1"}, a);
        NewEle("", "div", "background-position:-" + 86 * b + "px -" + 91 * g + "px", {className: "Tom2"}, a)
    }
},
